    ...
    <form wire:submit.prevent="addResident">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" id="surname" wire:model.defer="surname" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" />
                @error('surname') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
            </div>

            <div>
                <label for="first_name" class="block text-sm font-medium text-gray-700">First Name</label>
                <input type="text" id="first_name" wire:model.defer="first_name" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" />
            ...
            <div>
                ...
                <input type="text" id="relationship_with_family_head" wire:model.defer="relationship_with_family_head" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" />
                @error('relationship_with_family_head') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
            </div>

            <div>
                <label for="civil_status" class="block text-sm font-medium text-gray-700">Civil Status</label>
                <select id="civil_status" wire:model.defer="civil_status" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
            ...
            <div>
                ...
                <input type="text" id="religion" wire:model.defer="religion" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus focus sm" /> @error('religion') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror </div>
                <div>
                    <label for="citizenship" class="block text-sm font-medium text-gray-700">Citizenship</label>
                    <input type="text" id="citizenship" wire:model.defer="citizenship" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" />
                ...
                <div>
                    ...
                    <input type="number" id="family_number" wire:model.defer="family_number" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" />
                ...
                <div>
                    ...
                    <input type="text" id="zone_or_purok" wire:model.defer="zone_or_purok" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" />
