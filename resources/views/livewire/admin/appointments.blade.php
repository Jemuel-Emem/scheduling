...
<script>
    document.addEventListener('livewire:load', function() {
        Livewire.on('rescheduleOptionChanged', function(value) {
            if (value === 'date') {
                document.getElementById('reschedule_date_field').classList.remove('hidden');
            } else {
                document.getElementById('reschedule_date_field').classList.add('hidden');
            }
        });
    });
</script>
